...
<body>
	...
	<section>
		...
		<div style="margin: 40px">
			<div class="container events events-1" id="inner-page-title">
				<!-- TITLE & DESCRIPTION -->
				<div class="spe-title">
					<h2> <span>Validasi Pemesanan</span> </h2>
					<div class="title-line">
						<div class="tl-1"></div>
						<div class="tl-2"></div>
						<div class="tl-3"></div>
					</div>
					<form method="POST" action="<?php echo base_url()?>c_pemesanan/cetakPemesanan">
						<div class="col-md-2" style="margin: 5px">
							<input style="width: 200px" type="month" name="periode" class="form-control" >							
						</div>
						<div class="col-md-1" style="margin: 5px">
							<button class="link-btn" type="submit"><i class="fa fa-print"></i></button>
						</div>
					</form>
					...
					<table style="float: right" class="table table-striped table-bordered data">
						...
						<tbody>
							...
							<?php
								...
								<td>
									<a  class="edit_data" data-toggle="modal" data-target=".myModal" id="<?= $key->kode_pemesanan?>" ><i class="fa fa-users fa-6"></i></a>
									<a  class="delete" data-toggle="modal" data-target=".modalDelete"  id="<?= $key->kode_pemesanan?>" style="background-color: red" ><i class="fa fa-remove"></i></a>
								</td>
							</tr>
							<?php $no++;	} } ?>
						</tbody>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title">Data Penumpang</h4>
							</div>
							<div class="modal-body" id="penumpang">
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<form method="POST" action="<?= base_url()?>c_pemesanan/a_deletePemesanan">
								<input type="hidden" name="delete_pemesanan" id="delete_pemesanan" class="form-control" ></input>
	...
	<script type="text/javascript">
		$(document).on('click','.edit_data', function(){
			...
			$.ajax({
				url:"<?php echo base_url()?>c_pemesanan/a_editData/"+kode,
				method:"POST",
				data:{'kode':kode},
				dataType:"json",
			...
			$.ajax({
				url:"<?php echo base_url()?>c_pemesanan/a_penumpang/"+kode,
				method:"POST",
				data:{kode:kode},
				success: function(data){
					$('#penumpang').html(data);
