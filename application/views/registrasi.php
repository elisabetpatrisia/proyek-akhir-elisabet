			...
			<div class="tr-regi-form">
				<h4>Buat Akun Member</h4>
				 <?php if ($this->session->flashdata('failed')) {?>
				  ...
				  <?php } ?>
				<form class="col s12" method="POST" action="<?php echo base_url();?>c_login/a_registrasi">
					<div class="row">
						<div class="input-field col s12">
							<input type="text" id="namalengkap" class="validate" name="namalengkap" required>
							<label>Nama Lengkap</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col s12">
							<input type="number" class="validate" name="nohp" required>
					...
					<div class="row">
						<div class="input-field col s12">
							<input type="password" class="validate" name="cpassword" id="cpassword">
					...
					<div class="row">
						<div class="input-field col s12">
							<select name="jeniskelamin" class="validate">
				...
				<p>Sudah menjadi member ? <a href="login.html">Pilih untuk Login</a>
				</p>
			</div>
