...
<body>
	...
	<section>
		...
		<div style="margin: 40px">
			<div class="container events events-1" id="inner-page-title">
				<!-- TITLE & DESCRIPTION -->
				<div class="spe-title">
					<h2> <span>Tabel Terminal</span> </h2>
					<div class="title-line">
						<div class="tl-1"></div>
						<div class="tl-2"></div>
						<div class="tl-3"></div>
					</div>
					<a data-toggle="modal" data-target=".tambahTerminal" class="link-btn" style="margin: 5px;">Tambah Terminal</a>
					<a class="link-btn" href="<?= base_url()?>c_terminal/cetakTerminal" style="margin: 5px;"><i class="fa fa-print"></i></a>
				</div>
				<div class="container">
	...
	<div class="modal fade deleteModal">
		<div class="modal-dialog">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Anda yakin anda menghapus data terminal ini?</h4>	
			</div>
				<form method="POST" action="<?= base_url()?>c_terminal/hapusTerminal">
				<input type="hidden" name="id_terminal" id="delete_terminal" class="form-control" ></input>
	...
	<div class="modal fade tambahTerminal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				...
				<div class="modal-body">
					<form method="POST" action="<?php echo base_url()?>c_terminal/tambahTerminal" enctype="multipart/form-data">
						<span>Nama Terminal</span>
						<input class="validate form-control" type="text" name="nama_termial" required>
						<br/>
						<span>Kota</span>
						<input class="validate form-control" type="text" name="kota" required>
						<br/>	
						<span>Alamat</span>
						<input class="validate form-control" type="text" name="alamat" required>
				</div>	
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	...
	<div class="modal fade editMember">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?php echo base_url()?>c_bus/updateBus">
						<span>Nama Terminal</span>
						<input class="validate form-control" type="text" id="nama_terminal" name="nama_termial" required>
						<input class="validate form-control" type="hidden" id="id_terminal" name="id_terminal" required>
						<br/>
						<span>Kota</span>
						<input class="validate form-control" type="text" id="kota" name="kota" required>
						<br/>	
						<span>Alamat</span>
						<input class="validate form-control" type="text" id="alamat" name="alamat" required>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	...
	<script type="text/javascript">
		$(document).on('click','.edit', function(){
			...
			$.ajax({
				url:'<?php echo base_url()?>c_terminal/editTerminal/'+kode,
				type: 'POST',
				data: {'id':kode},
				dataType:'json',
				success: function(data){
					$('#id_terminal').val(data.id);
					$('#nama_terminal').val(data.nama_terminal);
