    ...
    $('#home_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#home_form").closest('form').find("input[type=text],input[type=tel],input[type=number],input[type=email], input[type=checkbox], textarea").val("");
            }
        });
        e.preventDefault();
        e.unbind();
    ...
    $('#home_enquiry').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                foo.attr("style", "display: block;");
                $("#home_enquiry").closest('form').find("input[type=text],input[type=tel],input[type=number],input[type=email], input[type=checkbox], textarea").val("");
            }
        });
        e.preventDefault();
        e.unbind();
    ...
    $('#tbook_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                var foo = $(".succ_mess");
                foo.attr("style", "display: block;");
                $("#tbook_form").closest('form').find("input[type=text],input[type=tel],input[type=number],input[type=email], input[type=checkbox], textarea").val("");
            }
        });
        e.preventDefault();
        e.unbind();
    ...
    $('#hbook_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                var foo = $(".succ_mess");
                foo.attr("style", "display: block;");
                $("#hbook_form").closest('form').find("input[type=text],input[type=tel],input[type=number],input[type=email], input[type=checkbox], textarea").val("");
            }
        });
        e.preventDefault();
        e.unbind();
