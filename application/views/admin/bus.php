...
<body>
	...
	<section>
		...
		<div style="margin: 40px">	
			<div class="container events events-1" id="inner-page-title">
				<!-- TITLE & DESCRIPTION -->
				<div class="spe-title">
					<h2> <span>Tabel  Bus</span> </h2>
					<div class="title-line">
						<div class="tl-1"></div>
						<div class="tl-2"></div>
						<div class="tl-3"></div>
					</div>
					<a data-toggle="modal" data-target=".tambahMember" class="link-btn" style="margin: 5px">Tambah Bus</a>
					<a class="link-btn" href="<?= base_url()?>c_bus/cetakBus" style="margin: 5px;"><i class="fa fa-print"></i></a>
				</div>
				<div class="container">
	...
	<div class="modal fade deleteModal">
		<div class="modal-dialog">
			...
			<div class="modal-header">
				...
				<form method="POST" action="<?= base_url()?>c_bus/hapusBus">
				<input type="hidden" name="id_bus" id="delete_bus" class="form-control" ></input>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?php echo base_url()?>c_bus/tambahBus" enctype="multipart/form-data">
						<span>Nopol</span>
						<input class="validate form-control" type="text" name="nopol" required>
						<br/>
						<span>Tahun</span>
						<input class="validate form-control" type="text" name="tahun" required>
						<br/>	
						<span>Merk</span>
						<input class="validate form-control" type="text" name="merk" required>
						<br/>
						<span>Deskripsi</span>
						<textarea name="deksripsi" class="validate form-control"></textarea>
						<span>Foto</span>
						<input class="validate form-control" type="file" name="foto" required>
				</div>	
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?php echo base_url()?>c_bus/updateBus">
						<span>Nopol</span>
						<input class="validate form-control" type="text" name="nopol" id="nopol" required>
						<input class="validate form-control" type="hidden" name="id" id="id_bus" required>
						<br/>
						<span>Tahun</span>
						<input class="validate form-control" type="text" name="tahun" id="tahun" required>
						<br/>	
						<span>Merk</span>
						<input class="validate form-control" type="text" name="merk" id="merk" required>
						<br/>
						<span>Deskripsi</span>
						<textarea name="deskripsi" class="validate form-control" id="deskripsi"></textarea>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	...
	<script type="text/javascript">
		$(document).on('click','.edit', function(){
			...
			$.ajax({
				url:'<?php echo base_url()?>c_bus/editBus/'+kode,
				type: 'POST',
				data: {'id':kode},
				dataType:'json',
