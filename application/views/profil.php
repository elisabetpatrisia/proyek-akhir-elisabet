				...
				<div class="db-2-com db-2-main">
					...
					<div class="db-2-main-com db-2-main-com-table">
						...
						<table class="responsive-table">
							<tbody>
								...
								<tr>
									...
									<td>:</td>
									<?php
										if ($key->sys_role_id == 1) { ?>
									<td><span class="db-done">Member</span>

									<?php	} else {?>
									<td><span class="db-done">Admin</span>
						...
						<div class="db-mak-pay-bot">
							 <a href="<?php echo base_url()?>konsumen/v_editProfil/<?= $this->session->userdata['logged_in']['id']?>" class="waves-effect waves-light btn-large">Edit my profile</a> </div>
					</div>
				</div>
			</div>
		</div>
